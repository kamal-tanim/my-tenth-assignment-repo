...
const Home = () => {
    return (
        <div className=''>
            ...
            <div className='mx-auto p-1 rounded-2xl'>
            ...
            <div className='p-10'>
                ...
                >
                    ...
                    <div className="border mt-10 border-white/30 bg-white/20  backdrop-blur-lg rounded-full p-10">
                    ...
                    <div className='flex mt-10 items-center'>
                        <p className='text-white text-4xl text-center font-semibold '><span className='text-[60px] font-bold'>30+</span><br />Ai Models</p>
                        <span className='h-20 w-0.5 bg-white rounded-full mx-25'></span>
                        <p className='text-white text-4xl text-center font-semibold '><span className='text-[60px] font-bold'>40,000+</span><br />Active Users</p>
                        <span className='h-20 w-0.5 bg-white rounded-full mx-25'></span>
                        <p className='text-white text-4xl text-center font-semibold '><span className='text-[60px] font-bold'>28+</span><br />Countries</p>
