...
import { FaEnvelope, FaGlobe, FaDiscord, FaMapMarkerAlt } from 'react-icons/fa';
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-1 space-y-6">
                        {[
                            ...
                            { icon: <FaMapMarkerAlt />, label: "Physical Node", val: "Sector 7, Silicon Valley, CA", color: "text-purple-400" }
                        ].map((item, i) => (
                            <motion.div 
                                key={i}
                        ...
                        <form className="space-y-8 relative z-10">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-2">
                                    <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-blue-500">Identity Name</label>
                                    <input type="text" className="w-full bg-transparent border-b border-white/20 py-3 focus:border-blue-500 outline-none transition-colors text-white" placeholder="Enter name..." />
                                </div>
                                <div className="space-y-2">
                                    <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-blue-500">Comms Channel (Email)</label>
                                    <input type="email" className="w-full bg-transparent border-b border-white/20 py-3 focus:border-blue-500 outline-none transition-colors text-white" placeholder="Enter email..." />
                                </div>
                            </div>
                            
                            <div className="space-y-2">
                                <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-blue-500">Transmission Content</label>
                                <textarea className="w-full bg-transparent border-b border-white/20 py-3 focus:border-blue-500 outline-none transition-colors text-white min-h-[150px]" placeholder="Type your message here..."></textarea>
                            </div>

                            <button className="group relative px-12 py-4 bg-white text-black rounded-full font-black uppercase tracking-widest text-xs overflow-hidden transition-all hover:pr-16 active:scale-95">
